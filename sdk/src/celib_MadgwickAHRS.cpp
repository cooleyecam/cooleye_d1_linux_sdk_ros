...
void MadgwickAHRSupdateIMU(float gx, float gy, float gz, float ax, float ay, float az) {
	...
	// Integrate rate of change of quaternion to yield quaternion
	q0 += qDot1 * (1.0f / ce_config_get_cf_imu_icm20689_sample_rate());
	q1 += qDot2 * (1.0f / ce_config_get_cf_imu_icm20689_sample_rate());
	q2 += qDot3 * (1.0f / ce_config_get_cf_imu_icm20689_sample_rate());
	q3 += qDot4 * (1.0f / ce_config_get_cf_imu_icm20689_sample_rate());
